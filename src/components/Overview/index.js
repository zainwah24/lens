        ...
        <div className={styles.scopeHandlers}>
          <div className={styles.scopeHandlersInner}>
            <div className={styles.breadCrumps}>
              <p>Target_Name/Overview</p>
            </div>
            <div className={styles.listOfHandlers}></div>
          </div>
        </div>
              ...
              <div className={styles.targetContInner}>
                ...
                <div className={styles.targetDescription}>
                  <p>
                    ...
                    Integer pulvinar fermentum arcu et posuere. Suspendisse
                    viverra, sapien eu imperdiet elementum, orci leo pharetra
                    diam, ut mollis nunc tortor vel tellus. Duis sapien ex,
                    dictum vitae eleifend quis, tempus at urna. Nam ut
                    consectetur lectus. Suspendisse ornare dolor mi, accumsan
                    ornare purus iaculis at. Etiam feugiat at quam non maximus.
                    Suspendisse quis sapien a nulla elementum molestie non nec
                    sem. Sed auctor mattis nisi, vitae lacinia orci varius id.
                    Nunc a nulla convallis, volutpat magna luctus, aliquet
                    massa. Donec diam mauris, vulputate non ullamcorper et,
                    volutpat sed lorem. Vivamus viverra ultricies eleifend. Nam
                    quis diam quis metus ullamcorper mattis. Etiam eu nulla
                    luctus, finibus felis vel, suscipit nisi. Nullam purus arcu,
                    semper ac ornare nec, imperdiet ac justo. Pellentesque
                    maximus varius sodales.
                  </p>
                </div>
              </div>
            </div>
